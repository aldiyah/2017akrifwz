                                    ...
                                    <?php if ($records != FALSE): ?>
                                        <?php foreach ($records as $key => $record): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo date('d M Y', strtotime($record->tr_aktifitas_tanggal)) ?>
                                                </td>
                                                <td>
                                                    <?php echo beautify_str($record->aktifitas_nama) ?><br>
                                                    <strong>Laporan : </strong> <?php echo beautify_str($record->tr_aktifitas_keterangan) ?>
                                                </td>
                                                <td>
                                                    <?php echo beautify_str($record->tr_aktifitas_mulai . "-" . $record->tr_aktifitas_selesai) ?>
                                                </td>
                                                <td>
                                                    <?php echo beautify_str($record->tr_aktifitas_status == 0 ? "Input" : "Lapor") ?>
                                                </td>
                                                <td>
