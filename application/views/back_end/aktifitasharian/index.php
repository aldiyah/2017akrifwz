                            ...
                            <tbody>
                                <?php foreach ($records as $data) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $status[$data->aktifitas_status] ?></td>
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm btn-group-icon">
                                                ...
                                                if ($data->aktifitas_status == 0) {
                                                    ...
                                                    echo anchor(backend_url('aktifitasharian/lihat/' . $tanggal . '/' . $data->tr_aktifitas_id), '<span class="fa fa-eye"></span>', 'class="btn btn-default"');
                                                }
//                                                echo anchor(backend_url('aktifitasharian/delete/' . $data->tr_aktifitas_id), '<span class="fa fa-trash-o"></span>', 'class="btn btn-default btn-hapus-row"');
                                                ?>
                                            </div>
                                        </td>
                                    </tr>
