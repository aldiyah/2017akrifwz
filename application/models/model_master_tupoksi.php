...
class Model_master_tupoksi extends Master_tupoksi {
    ...
    protected $rules = array(
        array("tupoksi_uraian", "required|min_length[3]|max_length[200]"),
    ...
    public function get_like($keyword = FALSE) {
        $result = FALSE;
        if ($keyword) {
            $this->db->order_by("tupoksi_uraian", "asc");
            $this->db->where(" lower(" . $this->table_name . ".tupoksi_uraian) LIKE lower('%" . $keyword . "%')", NULL, FALSE);
