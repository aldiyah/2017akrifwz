...
class Tpuraian extends Back_end {

    public $model = 'model_tp_uraian';

    public function __construct() {
        parent::__construct('kelola_tupoksi_uraian', 'Uraian Tupoksi');
    ...
    public function index($id_tupoksi = FALSE) {
        ...
        $this->model_tp_uraian->change_offset_param("currpage_" . $this->cmodul_name);
        $records = $this->model_tp_uraian->all($id_tupoksi);
        ...
        $this->set('field_id', $this->model_tp_uraian->primary_key);
        ...
        $this->set('next_list_number', $this->model_tp_uraian->get_next_record_number_list());
    ...
    public function uraian($id = FALSE) {
        $this->load->model('model_tp_uraian');
        ...
        $this->set('uraian', $this->model_tp_uraian->get_uraian($id));
    }
